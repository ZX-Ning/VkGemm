...
slangc gemm_coopmat_opt.slang -profile spirv_1_6 -capability spvCooperativeMatrixKHR -o gemm_coopmat_opt.spv -O3 
slangc gemm_coopmat_tiled_opt.slang -profile spirv_1_6 -capability spvCooperativeMatrixKHR -capability spvGroupNonUniform -o gemm_coopmat_tiled_opt.spv -O3 
